...
export default function SettingsPage() {
  ...
  const connections = [
    { name: 'Finnhub 1', ok: conn.finnhub, label: 'Market data (primary)' },
    { name: 'Finnhub 2', ok: conn.finnhub2, label: 'Market data (secondary)' },
    { name: 'Alpha Vantage 1', ok: conn.alphaVantage, label: 'Market data (fallback)' },
    { name: 'Alpha Vantage 2', ok: conn.alphaVantage2, label: 'Market data (fallback)' },
    { name: 'Alpha Vantage 3', ok: conn.alphaVantage3, label: 'Market data (fallback)' },
    { name: 'Alpha Vantage 4', ok: conn.alphaVantage4, label: 'Market data (fallback)' },
    ...
    <div style={{ animation: "fi .4s ease", maxWidth: 640 }}>
      ...
      <GlassCard style={{ padding: "20px 22px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 0" }}>
          ...
          <div 
            onClick={() => {
              // AfridiGit065: Wire to ThemeProvider once available
              toast('info', 'Theme customization requires ThemeProvider');
            }}
            style={{
