...
import { Search as SearchIcon, TrendingUp, BarChart3, ExternalLink, Loader2, Bot } from 'lucide-react';
            ...
            <GlassCard key={t.sym} style={{ padding: "14px 18px", display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ display: "flex", gap: 12, marginTop: 8 }}>
                  <Link href={`/compare?symbol=${t.sym}`} style={{ textDecoration: "none" }}>
                    <span style={{ fontSize: 11, color: U.textFaint, display: "flex", alignItems: "center", gap: 4 }}>
                      <BarChart3 size={11} /> Compare
                    </span>
                  </Link>
                  <Link href={`/technical?symbol=${t.sym}`} style={{ textDecoration: "none" }}>
                    <span style={{ fontSize: 11, color: U.textFaint, display: "flex", alignItems: "center", gap: 4 }}>
                      <TrendingUp size={11} /> Technical
                    </span>
                  </Link>
                  <Link href={`/copilot?symbol=${t.sym}`} style={{ textDecoration: "none" }}>
                    <span style={{ fontSize: 11, color: U.textFaint, display: "flex", alignItems: "center", gap: 4 }}>
